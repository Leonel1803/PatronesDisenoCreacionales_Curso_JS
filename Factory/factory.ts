...
// STEP 1
interface BaseCar { //Uso de interfaces en TS. Las diferencia de una clase a una interfaz es que las interfaces no se pueden instanciar
    showCost(): void; //Metodo abstracto
}
