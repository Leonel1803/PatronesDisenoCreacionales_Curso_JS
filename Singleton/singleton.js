...
class Singleton {
    static instance = undefined; //Bandera para verificar si se ha hecho una instancia
    ...
    static getInstance(version) {
      if (!Singleton.instance) { //Si no se ha instanciado nunca
        Singleton.instance = new Singleton(version); //Entonces crea una instancia
      }
